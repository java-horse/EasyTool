...
public class DynamicWebSearchActionGroup extends DefaultActionGroup {
    ...
    public AnAction[] getChildren(@Nullable AnActionEvent e) {
        return new AnAction[]{
                new WebSearchAction(WebSearchEnum.BAIDU.title),
                new WebSearchAction(WebSearchEnum.BING.title),
                new WebSearchAction(WebSearchEnum.GOOGLE.title),
                new WebSearchAction(WebSearchEnum.STACK_OVERFLOW.title),
        };
    }
