...
public class BasicFormatter {
    ...
    private static final Set<String> BEGIN_CLAUSES = new HashSet<>(16);
    private static final Set<String> END_CLAUSES = new HashSet<>(16);
    private static final Set<String> LOGICAL = new HashSet<>(16);
    private static final Set<String> QUANTIFIERS = new HashSet<>(16);
    private static final Set<String> DML = new HashSet<>(16);
    private static final Set<String> MISC = new HashSet<>(16);
