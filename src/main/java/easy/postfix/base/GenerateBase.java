...
import easy.postfix.util.PsiDocumentUtil;
...
public interface GenerateBase {
    ...
    public static final Logger log = Logger.getInstance(GenerateBase.class);
    ...
    default Pair<String, String> handlerByPsiType(Set<String> newImportList, Project project, PsiType psiFieldType, String typeNameFormat, String typeName) {
        ...
        if (psiFieldType instanceof PsiClassReferenceType) {
            ...
            log.warn(fieldTypeName + " ==> not basic type, not ReferenceType");
        }
        return Pair.of(fieldTypeName, right);
    }
     ...
     * @return 类型
     */
    default Pair<String, String> getFieldTypeNameByCollection(Set<String> newImportList, Project project, String typeNameFormat,
                                                              String fieldTypeName, PsiType[] parameters, String right, String importCodeStr, String format) {
    ...
    default void insertCodeByPsiTypeWithTemplate(Document document, PsiDocumentManager psiDocumentManager, PsiFile containingFile, Editor editor, Variable... variableArray) {
        ...
        Template template = manager.createTemplate(StringUtils.EMPTY, StringUtils.EMPTY, insertCode + "$END$");
