...
public class JavaDocSettingConfigurable implements Configurable {
    ...
    public boolean isModified() {
        return !StringUtils.equals(javaDocConfig.getAuthor(), javaDocSettingView.getAuthorTextField().getText())
                ...
                || !StringUtils.equals(javaDocConfig.getCoverModel(), String.valueOf(javaDocSettingView.getPropertyCommentModelComboBox().getSelectedItem()));
    }
    ...
    public void apply() throws ConfigurationException {
        ...
        javaDocConfig.setCoverModel(String.valueOf(javaDocSettingView.getPropertyCommentModelComboBox().getSelectedItem()));
    }
