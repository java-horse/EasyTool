...
public class JavaDocSettingConfigurable implements Configurable {
    ...
    public boolean isModified() {
        return !StringUtils.equals(javaDocConfig.getAuthor(), javaDocSettingView.getAuthorTextField().getText())
                ...
                || !StringUtils.equals(javaDocConfig.getCoverModel(), String.valueOf(javaDocSettingView.getCoverModelComboBox().getSelectedItem()))
                || !Objects.equals(javaDocConfig.getCoverHintPrompt(), javaDocSettingView.getCoverHintPromptCheckBox().isSelected());
    }
    ...
    public void apply() throws ConfigurationException {
        ...
        javaDocConfig.setCoverModel(String.valueOf(javaDocSettingView.getCoverModelComboBox().getSelectedItem()));
        javaDocConfig.setCoverHintPrompt(javaDocSettingView.getCoverHintPromptCheckBox().isSelected());
    }
