...
public class DoGsonAnnotationService extends DoAbstractAnnotationService {
    ...
    public void removeAnnotation(PsiElement psiElement) {
        WriteCommandAction.runWriteCommandAction(project, () -> doRemove( ExtraPackageNameEnum.SERIALIZED_NAME.getName(),
                psiElement instanceof PsiField ? (PsiField) psiElement : (PsiClass) psiElement));
    }
}
